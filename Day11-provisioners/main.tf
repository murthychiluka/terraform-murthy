...
#       "echo 'hello from Murthy hyd' >> /home/ubuntu/file200"
#     ]
#   }
...
resource "null_resource" "run_script" {
    ...
    connection {
      host        = aws_instance.server.public_ip # you can use self ip
      user        = "ubuntu"
   ...
   inline = [
      #"echo 'hello from Murthy hyd India' >> /home/ubuntu/file200"
       "bash /home/ubuntu/script.sh" # Assuming dev.sh is already on the instance 
    ]
  }
